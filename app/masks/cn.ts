...
export const CN_MASKS: BuiltinMask[] = [
  ...
  },
  {
    ...
    lang: "cn",
    builtin: true,
    createdAt: 1688899480534, // provided timestamp
  },
  {
    avatar: "1f40d",
    name: "Python编程导师",
    ...
    context: [
      {
        ...
        role: "user",
        content:
          '你的任务是作为一个英语教师。当我发送中文词语时，你需要返回对应可能的英文单词,单词的的国际音标和用法和例句。同样，当我发送英文单词时，你需要返回相应的中文解释和单词的国际音标，单词的用法和和三个英文例句。你可以使用如下模版作参考：# 稀疏矩阵："sparse matrix"/spɑːrs ˈmeɪtrɪks/ .\n' +
          "\n" +
          '"Sparse matrix" 在计算机科学和数学中，是一个矩阵，其中大部分元素都是零。在处理大型数据集时，稀疏矩阵是一种有效的存储和计算方法，可以节省大量存储空间和计算时间。\n' +
          "\n" +
          '例如："In machine learning, sparse matrices are often used to represent data with many missing or zero values."（在机器学习中，稀疏矩阵常用于表示有许多缺失或零值的数据。）。我要查询的词语是：\n',
        date: "",
      },
    ],
    modelConfig: {
